...
public class ObstaculoNegativoEstado implements IObstaculoEstado {
    ...
    /**
     * Funcion que determina si exite coolcion entre los objetos del juego y
     * disminuir vida al personaje
     *
     * @param partida parametro que nos a acceso a los objetos que pueden
     * colisionar
     */
    @Override
